...
class BeforeLogin extends StatefulWidget {
  ...
  @override
  BeforeLoginState createState() => BeforeLoginState();
}

class BeforeLoginState extends State<BeforeLogin> {
  ...
  void onDonePress() {
    ...
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => GlobalUtils.errorMessage("msg")),
    );
  }
